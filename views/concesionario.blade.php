...
<div class="row mt-5">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Concesionarios Registrados</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <div id="example23_wrapper" class="dataTables_wrapper"><div id="example23_filter" class="dataTables_filter"><label>Search:<input type="search" class="" placeholder="" aria-controls="example23"></label></div><table id="example23" class="display nowrap table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 100%;">
                                        <thead>
                                            ...
                                            <tr><th rowspan="1" colspan="1">ID</th><th rowspan="1" colspan="1">Concesionario</th><th rowspan="1" colspan="1">Creación</th><th rowspan="1" colspan="1">Acciones</th></tr>
                                        ...
                                        <tr role="row" class="odd">
                                                <td class="sorting_1">{{$concesionario->id}}</td>
                                                <td>{{$concesionario->concesionario}}</td>
                                                <td>{{$concesionario->created_at}}</td>
                                                <td>{{$concesionario->updated_at}}</td>
